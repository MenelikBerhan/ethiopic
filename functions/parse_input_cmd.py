...
def parse_default_cmd(line):
    ...
    parser.add_argument('-tl', '--lang', dest='lang', required=False, nargs=1, choices=['amh', 'eng', 'amh-old', 'tir', 'amh-old2', 'amh-old3', 'amh-dict'], metavar='language_default', help='Set default tesseract OCR language')
