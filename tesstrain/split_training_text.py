...
fonts = (
    'Abyssinica SIL', 'Droid Sans Ethiopic',
    'Droid Sans Ethiopic Bold', 'FreeSerif', 'Noto Sans Ethiopic', 'Noto Sans Ethiopic Bold')
...
for font in fonts:
    ...
    output_files_base_name = os.path.join(output_directory, f'{input_file_name}_{font_name}')
